...
//     $data = array(
//         array("val0" => "Ahmad Fauzi Kuncoro Yakti", "val1" => "UP PMPTSP Kel. Kebon Kacang", "val2" => "Kepala Unit Kel. Kebon Kacang", "val3" => "Fauzidkijkt@gmail.com"),
//         array("val0" => "Hari Keristian", "val1" => "UP PMPTSP Kel. Utan Kayu Utara", "val2" => "Kepala Unit Kel. Utan Kayu Utara", "val3" => "Kanitkelsungbam@gmail.com"),
//         array("val0" => "Safran", "val1" => "UP PMPTSP Kel. Karet Tengsin", "val2" => "Kepala Unit Kel. Karet Tengsin", "val3" => "apang2005@gmail.com"),
//         array("val0" => "Haris Permadi", "val1" => "UP PMPTSP Kel. Cempaka Baru", "val2" => "Kepala Unit Kel. Cempaka Baru", "val3" => "haris.permadi@gmail.com"),
//         array("val0" => "Agung Rheza Fauzi", "val1" => "UP PMPTSP Kel. Kebon Kosong", "val2" => "Kepala Unit Kel. Kebon Kosong", "val3" => "ptsp.kelurahankebonkosong@gmail.com"),
//         array("val0" => "Mangali Harefa", "val1" => "UP PMPTSP Kec. Tanjung Priok", "val2" => "Kasubbag TU Kec. Tanjung Priok", "val3" => "devan.top2013@gmail.com"),
//         array("val0" => "Zainuri", "val1" => "UP PMPTSP Kel. Karang Anyar", "val2" => "Kepala Unit Kel. Karang Anyar", "val3" => "ptspkaranganyar@gmail.com"),
//         array("val0" => "Rachmat Budiman", "val1" => "UP PMPTSP Kel. Pegadungan", "val2" => "Kepala Unit Kel. Pegadungan", "val3" => "ptsp.pegadungan@gmail.com"),
//         array("val0" => "Sukarno", "val1" => "UP PMPTSP Kel. Manggarai Selatan", "val2" => "Kepala Unit Kel. Manggarai Selatan", "val3" => "ptspkelurahanmanggaraiselatan@gmail.com"),
//         array("val0" => "Caesarah Elfadhia", "val1" => "UP PMPTSP Kec. Mampang Prapatan", "val2" => "Admin PTSP Kec. Mampang Prapatan", "val3" => "adm.ptspmampang@gmail.com"),
//         array("val0" => "Monica Leonora", "val1" => "UP PMPTSP Kel. Utan Panjang", "val2" => "Kepala Unit Kel. Utan Panjang", "val3" => "ptspkel.utanpanjang@gmail.com"),
//         array("val0" => "Andy Apdhani", "val1" => "UP PMPTSP Kel. Bintaro", "val2" => "Kepala Unit Kel. Bintaro", "val3" => "imtheface@gmail.com"),
//         array("val0" => "Sri Indah Susilowati", "val1" => "UP PMPTSP Kel. Duren Tiga", "val2" => "Kepala Unit Kel. Duren Tiga", "val3" => "ndahindah@gmail.com"),
//         array("val0" => "Kartika Methasari", "val1" => "UP PMPTSP Kel. Kartini", "val2" => "Kepala Unit Kel. Kartini", "val3" => "kartikamethasari@gmail.com"),
//         array("val0" => "Sondang Evelynda", "val1" => "UP PMPTSP Kel. Jatinegara Kaum", "val2" => "Plt Kepala Unit Kel. Jatinegara Kaum", "val3" => "sondangevelynda@gmail.com"),
//         array("val0" => "Sumitron Efendi", "val1" => "UP PMPTSP Kec. Tambora", "val2" => "Analis Dokumen Perizinan dan Non Perizinan Kec. Tambora", "val3" => "pmptsp.kecamatantambora@gmail.com"),
//         array("val0" => "Fitria Hedyanti", "val1" => "UP PMPTSP Kel. Pengadegan", "val2" => "Kepala Unit Kel. Pengadegan", "val3" => "ptsp.kel.pengadegan@gmail.com"),
//         array("val0" => "Waya Robin Subari", "val1" => "UP PMPTSP Kel. Gunung Sahari Selatan", "val2" => "Kepala Unit Kel. Gunung Sahari Selatan", "val3" => "subariwayarobin@gmail.com"),
//         array("val0" => "Oky Sigit Hartomo", "val1" => "UP PMPTSP Kel. Pondok Labu", "val2" => "Kepala Unit Kel. Pondok Labu", "val3" => "ptsp.kel.pdlabu@gmail.com"),
//         array("val0" => "Gunung Sarjono", "val1" => "UP PMPTSP Kel. Pejagalan", "val2" => "Kepala Unit Kel. Pejagalan", "val3" => "PTSP.PEJAGALAN@GMAIL.COM"),
//         array("val0" => "Suhendar", "val1" => "UP PMPTSP Kel. Serdang", "val2" => "Kepala Unit Kel. Serdang", "val3" => "ptsp.serdang@gmail.com"),
//         array("val0" => "Slamet Budi Mulyono", "val1" => "UP PMPTSP Kec. Koja", "val2" => "Kasubbag TU Kec. Koja", "val3" => "ptspkeckoja@gmail.com"),
//         array("val0" => "Handoko Dwi S", "val1" => "UP PMPTSP Kel. Cikoko", "val2" => "Kepala Unit Kel. Cikoko", "val3" => "ptsp.cikoko@gmail.com"),
//         array("val0" => "Widi Nygroho", "val1" => "UP PMPTSP Kel. Tambora", "val2" => "Kepala Unit Kel. Tambora", "val3" => "wdnugr@gmail.com"),
//         array("val0" => "Septo Purwhandoko", "val1" => "UP PMPTSP Kel. Rawajati", "val2" => "Staf Teknis Kel. Rawajati", "val3" => "septopurwhandoko@gmail.com"),
//         array("val0" => "Suryandari", "val1" => "UP PMPTSP Kec. Kemayoran", "val2" => "Kepala Unit Kec. Kemayoran", "val3" => "ptspkecamatankemayoran@gmail.com"),
//         array("val0" => "Endi Rahmani", "val1" => "UP PMPTSP Kel. Harapan Mulya", "val2" => "Kepala Unit Kel. Harapan Mulya", "val3" => "endi.rahmani@gmail.com"),
//         array("val0" => "Verry Handrias", "val1" => "UP PMPTSP Kel. Pasar Baru", "val2" => "Kepala Unit Kel. Pasar Baru", "val3" => "verry.handrias@gmail.com"),
//         array("val0" => "Robet", "val1" => "UP PMPTSP Kel. Cipinang Melayu", "val2" => "Kepala Unit Kel. Cipinang Melayu", "val3" => "satlakptspcipinangmelayu@gmail.com"),
//         array("val0" => "Darwis Saswianto", "val1" => "UP PMPTSP Kel. Mangga Dua Selatan", "val2" => "Kepala Unit Kel. Mangga Dua Selatan", "val3" => "ptsp.kelmanggaduaselatan@gmail.com"),
//         array("val0" => "Mona Safa Maria As", "val1" => "UP PMPTSP Kel. Kemayoran", "val2" => "Kepala Unit Kel. Kemayoran", "val3" => "mona.safamaria@gmail.com"),
//         array("val0" => "Ahmad Syarif Fajri", "val1" => "UP PMPTSP Kec. Cipayung", "val2" => "Kepala Unit Kec. Cipayung", "val3" => "mlie.ugm@gmail.com"),
//         array("val0" => "Arlan Andajaya", "val1" => "UP PMPTSP Kel. Gondangdia ", "val2" => "Kepala Unit Kel. Gondangdia", "val3" => "andajayaarlan@gmail.com"),
//         array("val0" => "Rini Sulistiowati", "val1" => "UP PMPTSP Kel. Pancoran", "val2" => "Kepala Unit Kel. Pancoran", "val3" => "ptspkelpancoran@gmail.com"),
//         array("val0" => "Heru Purwanto", "val1" => "UP PMPTSP Kel. Gunung Sahari Utara", "val2" => "Kepala Unit Kel. Gunung Sahari Utara", "val3" => "ptsp.gunungsahariutara@gmail.com"),
//         array("val0" => "David Michael Hasudungan", "val1" => "UP PMPTSP Kel. Pisangan Baru", "val2" => "Kepala Unit Kel. Pisangan Baru", "val3" => "david.sirait@gmail.com"),
//         array("val0" => "Indriyati", "val1" => "UP PMPTSP Kel. Gandaria Selatan", "val2" => "Kepala Unit Kel. Gandaria Selatan", "val3" => "indriichsan@gmail.com"),
//         array("val0" => "Utami Rustiyani", "val1" => "UP PMPTSP Kel. Rawa Badak Utara", "val2" => "Staf Teknis Kel. Rawa Badak", "val3" => "Ptsp.rawabadakutara@gmail.com"),
//         array("val0" => "Rahman Hidayat", "val1" => "UP PMPTSP Kel. Pegangsaan", "val2" => "Kepala Unit Kel. Pegangsaan", "val3" => "Pelayanan.pegangsaan@gmail.com"),
//         array("val0" => "Soviatun Hanifah", "val1" => "UP PMPTSP Kel. Cilandak Barat", "val2" => "Kepala Unit Kel. Cilandak Barat", "val3" => "hannysyakira2@gmail.com"),
//         array("val0" => "Lara Fitrianti", "val1" => "UP PMPTSP Kec. Pesanggrahan", "val2" => "CRO Kec. Pesanggrahan", "val3" => "larachman89@gmail.com"),
...
Route::get('/export-survey-perkembangan', function () {
    $geojson_format = [
        'type' => 'FeatureCollection',
        'features' => []
    ];

    $data = SurveyPerkembangan::with(['user.roles'])->get();
    // dd($data);
    foreach ($data as $d) {
