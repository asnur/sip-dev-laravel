...
(function (d) {
    "function" === typeof define && define.amd
        ...
        ? (module.exports = function (u, v) {
              u || (u = window);
              (v && v.fn.dataTable) || (v = require("datatables.net")(u, v).$);
              return d(v, u, u.document);
          })
    ...
    d.extend(t.prototype, {
        ...
        _constructor: function () {
            ...
            d("body").on("keyup." + this.s.namespace, function (b) {
                if (!v.activeElement || v.activeElement === v.body) {
                    var c = String.fromCharCode(b.keyCode).toLowerCase();
                    -1 !== a.s.listenKeys.toLowerCase().indexOf(c) &&
                        a._keypress(c, b);
                }
            });
        },
        ...
        _expandButton: function (a, b, c, e) {
            ...
            for (var k = 0, h = b.length; k < h; k++) {
                var q = this._resolveExtends(b[k]);
                if (q)
                    if (d.isArray(q)) this._expandButton(a, q, c, e);
                    else {
                        var l = this._buildButton(q, c);
                        l &&
                            (e !== p && null !== e
                                ? (a.splice(e, 0, l), e++)
                                : a.push(l),
                            ...
                            q.init &&
                                q.init.call(g.button(l.node), g, d(l.node), q),
                            f++);
                    }
            }
        },
        _buildButton: function (a, b) {
            ...
            g = a.tag || c.tag;
            var q = a.clickBlurs === p ? !0 : a.clickBlurs,
                l = d("<" + g + "/>")
            ...
            a.namespace || (a.namespace = ".dt-button-" + H++);
            e =
                ...
                e = function (c) {
                    for (var e = 0; !d.isPlainObject(c) && !d.isArray(c); ) {
                        ...
                        if ("function" === typeof c) {
                            ...
                            if (!n[c]) throw "Unknown button type: " + c;
                            c = n[c];
                        }
                        e++;
        ...
        _popover: function (a, b, c) {
            var e = this.c,
                ...
                f = b.node(),
                k = function () {
                    B(d(".dt-button-collection"), g.fade, function () {
                        d(this).detach();
                    });
                    d(
                        b
                    ...
                    t.background(!1, g.backgroundClassName, g.fade, f);
            ...
            f.parents("body")[0] !== v.body && (f = v.body.lastChild);
            g.collectionTitle &&
                c.prepend(
            ...
            A(c.insertAfter(f));
            e = d(b.table().container());
            var h = c.css("position");
            "dt-container" === g.align &&
                ((f = f.parent()), c.css("width", e.width()));
            if (
                "absolute" === h &&
                ...
                var q = f.position();
                c.css({ top: q.top + f.outerHeight(), left: q.left });
                var l = c.outerHeight(),
                    x = e.offset().top + e.height(),
                    y = q.top + f.outerHeight() + l;
                x = y - x;
                y = q.top - l;
                var m = e.offset().top,
                    p = q.top - l - 5;
                (x > m - y || g.dropup) && -p < m && c.css("top", p);
                q = e.offset().left;
                e = e.width();
                e = q + e;
                h = c.offset().left;
                ...
                "absolute" === h
                    ? ((q = f.position()),
                      ...
                      (m = e.offset().top),
                      (x > m - y || g.dropup) && -p < m && c.css("top", p),
                      (r = "button-right" === g.align ? n - w : r - h),
                      c.css("left", c.position().left + r))
                    : ((h = c.height() / 2),
                      h > d(u).height() / 2 && (h = d(u).height() / 2),
                      c.css("marginTop", -1 * h));
            g.background && t.background(!0, g.backgroundClassName, g.fade, f);
            ...
            d("body")
                .on("click.dtb-collection", function (b) {
                    var c = d.fn.addBack ? "addBack" : "andSelf",
                        e = d(b.target).parent()[0];
                    ((!d(b.target).parents()[c]().filter(a).length &&
                        !d(e).hasClass("dt-buttons")) ||
    ...
    t.buttonSelector = function (a, b) {
        for (
            var c = [],
                e = function (a, b, c) {
                    for (var d, f, g = 0, h = b.length; g < h; g++)
                        if ((d = b[g]))
                            (f = c !== p ? c + g : g + ""),
                                a.push({
                                    node: d.node,
                ...
                g = function (a, b) {
                    ...
                    if (d.isArray(a) || a instanceof d)
                        ...
                        if (-1 !== a.indexOf(","))
                            ...
                            for (
                                a = a.replace(":name", ""), h = 0, f = k.length;
                                h < f;
                                h++
                            )
                                k[h].name === a &&
    ...
    d.extend(n, {
        ...
        copy: function (a, b) {
            if (n.copyHtml5) return "copyHtml5";
            if (n.copyFlash && n.copyFlash.available(a, b)) return "copyFlash";
        },
        csv: function (a, b) {
            if (n.csvHtml5 && n.csvHtml5.available(a, b)) return "csvHtml5";
            if (n.csvFlash && n.csvFlash.available(a, b)) return "csvFlash";
        },
        excel: function (a, b) {
            if (n.excelHtml5 && n.excelHtml5.available(a, b))
                return "excelHtml5";
            if (n.excelFlash && n.excelFlash.available(a, b))
                return "excelFlash";
        },
        pdf: function (a, b) {
            if (n.pdfHtml5 && n.pdfHtml5.available(a, b)) return "pdfHtml5";
            if (n.pdfFlash && n.pdfFlash.available(a, b)) return "pdfFlash";
        },
    ...
    m.Api.register("buttons()", function (a, b) {
        ...
        var c = this.iterator(
            ...
            function (c) {
                if (c._buttons)
                    return t.buttonSelector(
                        t.instanceSelector(a, c._buttons),
                        b
                    );
            },
            !0
    ...
    m.Api.register("buttons.info()", function (a, b, c) {
        ...
        if (!1 === a)
            return (
                ...
                B(d("#datatables_buttons_info"), 400, function () {
                    d(this).remove();
                }),
                clearTimeout(z),
                (z = null),
    ...
    m.Api.register("buttons.exportData()", function (a) {
        if (this.context.length) return I(new m.Api(this.context[0]), a);
    });
    m.Api.register("buttons.exportInfo()", function (a) {
        ...
        return {
            filename: c,
            title: b,
            messageTop: E(this, a.message || a.messageTop, "top"),
            messageBottom: E(this, a.messageBottom, "bottom"),
        };
    });
    var C = function (a) {
            return null === a || a === p
        ...
        I = function (a, b) {
            var c = d.extend(
                ...
                e = function (a) {
                    ...
                    c.decodeEntities && ((F.innerHTML = a), (a = F.value));
                    return a;
                };
            b = a
                .columns(c.columns)
            ...
            for (
                ...
                for (var v = [h], u = 0; u < h; u++)
                    (v[u] = c.format.body(f[l], n, u, k[l])), l++;
                m[n] = v;
            }
    ...
    d.fn.DataTable.Buttons = t;
    d(v).on("init.dt plugin-init.dt", function (a, b) {
        "dt" === a.namespace &&
            (a = b.oInit.buttons || m.defaults.buttons) &&
            !b._buttons &&
            new t(b, a).container();
    });
    m.ext.feature.push({ fnInit: D, cFeature: "B" });
    m.ext.features && m.ext.features.register("buttons", D);
    return t;
});
