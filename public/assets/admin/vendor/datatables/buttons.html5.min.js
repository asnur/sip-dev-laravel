...
(function (f) {
    ...
    var B = (function (a) {
        if (
            ...
            var b = a.document.createElementNS(
    ...
    v.ext.buttons.excelHtml5 = {
        ...
        action: function (a, b, d, c) {
            ...
            m.messageBottom &&
                (q([m.messageBottom], e), x(e, k.header.length - 1));
            q = r(h, "cols");
            ...
            0 === f("mergeCells", h).children().length &&
                f("mergeCells", h).remove();
            b = new (z || g.JSZip)();
            d = {
                type: "blob",
                mimeType:
    ...
    v.ext.buttons.pdfHtml5 = {
        ...
        action: function (a, b, d, c) {
            ...
            d = {
                ...
                content: [
                    { table: { headerRows: 1, body: l }, layout: "noBorders" },
                ],
                styles: {
                    tableHeader: {
                        bold: !0,
