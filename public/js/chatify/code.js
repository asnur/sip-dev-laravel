    ...
    $.ajax({
        ...
        success: (data) => {
            ...
            if (id_admin > 0) {
                ...
                <table class="messenger-list-item message-admin"  data-contact="${id_admin}">
                <tbody>
                    <tr data-action="0">
                        <td style="position: relative">
                            <div class="avatar av-m" style="background-image: url(${APP_URL}/storage/users-avatar/eb379934-2170-4ad8-a735-a4cd54080685.png);">
                            </div>
                        </td>
                        <td>
                            <p data-id="user_${id_admin}">
                            ADMIN-${kelurahan}
                        </td>
                    </tr>
                </tbody>
                ...
                $("body")
                    .find(".listOfContacts")
                    .find(".messenger-list-item[data-contact=" + id_admin + "]")
                    .click();
            }
            if (
                $(".messenger-list-item[data-contact=" + id_admin + "]")
                    .length > 1
            ) {
                $(
                    ".messenger-list-item[data-contact=" + id_admin + "]:eq(0)"
                ).hide();
            }
    ...
    function attachmentValidate(file) {
        ...
        if (typeof file != "undefined") {
            var allowedExtensions =
                /(\.jpg|\.jpeg|\.png|\.gif|\.zip|\.rar|\.txt)$/i;
