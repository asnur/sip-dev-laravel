...
@section('lokasi')
    ...
    <div class="container margin_conten_permenu">
        ...
        <div class="d-flex space_judul row_mid_judul">
            ...
            <div class="col-md-7 text_all_permenu">
                <p class="rata_text_mobile">{{ $data_zonasi['Zona'] }}</p>
            </div>
        </div>
        ...
        <div class="d-flex space_text row_mid_text">
            ...
            <div class="col-lg-7 text_all_permenu">
                <p class="rata_text_mobile">{{ $data_zonasi['Sub Zona'] }} - {{ $data_zonasi['Zona'] }}</p>
            </div>
        </div>
        ...
        <div class="d-flex space_text row_mid_text">
            ...
            <div class="col-lg-7 text_all_permenu">
                <p class="rata_text_mobile">{{ $data_zonasi['Kode Blok'] }}/{{ $data_zonasi['Sub Blok'] }}</p>
            </div>
        </div>
        ...
        <div class="d-flex space_text row_mid_text">
            ...
            <div class="col-lg-7 text_all_permenu">
                <p class="rata_text_mobile">{{ $data_zonasi['TPZ'] }}</p>
            </div>
        </div>
        ...
        <div class="d-flex space_text row_mid_text">
            ...
            <div class="col-lg-7 text_all_permenu">
                <p class="rata_text_mobile">{{ $data_zonasi['CD TPZ'] }}</p>
            </div>
        </div>
        ...
        <div class="d-flex space_text row_mid_text">
            ...
            <div class="col-lg-7 text_all_permenu">
                <p class="rata_text_mobile">{{ $data_zonasi['KDH'] }}</p>
            </div>
        </div>
        ...
        <div class="d-flex space_text row_mid_text">
            ...
            <div class="col-lg-7 text_all_permenu">
                <p class="rata_text_mobile">{{ $data_zonasi['KLB'] }}</p>
            </div>
        </div>
