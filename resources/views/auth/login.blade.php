...
@section('content')
    <div class="flex flex-row min-h-screen">
        <div class="w-9/12">
            <video class="object-fill w-full h-full" src="{{ asset('assets/login/bg_video.mp4') }}" type="video/mp4" autoplay
                muted loop></video>
        </div>
            ...
            <div class="flex flex-col h-screen">
                <div class="flex flex-row items-center justify-center bg-white">
                    <div class="flex items-center justify-center mr-6 mb-1">
                        <img class="" style="width: 100%" src="{{ asset('assets/login/logo_jakpintas.png') }}"
                            alt="" />
                    </div>
