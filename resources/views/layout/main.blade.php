...
<body>
                                            ...
                                            <div class="kotak_sidebar">
                                                ...
                                                <div>
                                                    <a href="#" title="Buat File"
                                                        class="text_all_kotak_sidebarr">Konsultasi</a></div>
                        ...
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            ...
                            <li class="col-xs-3 col-sm-3 col-md-3 col-lg-3 p-2 nav-item">
                                <a class="btn btn-outline-primary btn-md tombol_menu padding_icon_navpill"
                                    ...
                                    aria-controls="pills-zonasi" aria-selected="false"><i class="ri-map-2-fill"></i></a>
                                <br>
                ...
                <div class="container container_menu for_mobile">
                    ...
                    <div style="margin-top: -6%;" class="text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48">
                            ...
                            <path d="M5 11h14v2H5z" fill="rgba(211,211,211,1)" /></svg>
                    </div>
    ...
    <script>
        ...
        //         'type': 'geojson',
        //         'data': 'https://jakpintas.dpmptsp-dki.com:3000/choro'
        //     });
        //     map.addLayer({
        //             'id': 'wilayah-fill',
        //             'type': 'fill',
