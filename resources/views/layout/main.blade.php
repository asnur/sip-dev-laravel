                                ...
                                <div class="search_box">
                                    ...
                                    <div class="new_login">
                                        <div class="dropdown">
                                            ...
                                            <img src="{{ url('storage/profile/'.Auth::user()->id) }}.jpg" style="border-radius: 50%; width:36px;  height:36px;" id="btnLogout" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
