                    ...
                    <div class="card responsive_jarak">
                        ...
                        <div class="card-header responsive_card">
                            ...
                            <div class="row responsive_row">
                                ...
                                <div class="col-md-9">
                                    <h3 style="font-size: 14px; width: 19rem; margin-top: 0.5rem;"
                                        class="card-title text-break text-primary">Pengunjung 7 Hari Terakhir</h3>
                                </div>
                        ...
                        <div class="card-body responsive_delete_card">
                            ...
                            <div style="font-size:40px;" class="h2 m-0 inf-pengunjung angka_responsive"
                                onload="visitorToday()">
                    ...
                    <div class="card responsive_jarak">
                        ...
                        <div class="card-header responsive_card">
                            ...
                            <div class="row responsive_row">
                                <div class="col-md-9">
                                    <h3 style="font-size: 14px; width: 19rem; margin-top: 0.5rem"
                                        class="card-title text-break text-success">
                                        Titik Tercatat
                                    </h3>
                                </div>
                    ...
                    <div class="card responsive_jarak">
                        ...
                        <div class="card-header responsive_card">
                            ...
                            <div class="row responsive_row">
                                <div class="col-md-9">
                                    <h3 style="font-size: 14px; width: 19rem; margin-top: 0.5rem"
                                        class="card-title text-break text-orange">
                                        Pegawai Terdaftar
                                    </h3>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div style="max-height: 38em !important;height: 33em !important;" class="row">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        ...
                                        <div
                                            class="gambar_utama_slider_input gambar_utama_slider_input_scale atur_margin_gambar_utama data_image_space">
                                    ...
                                    <div sty class="col-md-6 mt-2">
                                        ...
                                        <div class="teks_height">
                                            <div class="row jarak_judul">
                                                <div class="col-md-5">
                                                    <label class="form-label">Nama Lokasi <span
                                                            style="margin-left: 3.7rem;"> </span></label>
                                                </div>
                                            ...
                                            <div class="row jarak_judul">
                                                <div class="col-md-5">
                                                    <label class="form-label">Koordinat <span
                                            ...
                                            <div class="row jarak_judul">
                                                <div class="col-md-5">
                                                    <label class="form-label">ID Sub Blok <span
                                                            style="margin-left: 2.5rem;"> </span></label>
                                                </div>
                                                <div class="col-md-7 jarak_text">
                                                    <div class="col text_data_terbaru">
                                                        <span id="id_sub_blok">
                                            ...
                                            <div class="row jarak_judul">
                                                <div class="col-md-5">
                                                    <label class="form-label">Kelurahan <span
                                            ...
                                            <div class="row jarak_judul">
                                                <div class="col-md-5">
                                                    <label class="form-label">Pola Regional <span
                                                            style="margin-left: 3.5rem;"> </span></label>
                                                </div>
                                                <div class="col-md-7 jarak_text">
                                                    <div class="col text_data_terbaru">
                                                        <span id="regional">
                                            ...
                                            <div class="row jarak_judul">
                                                <div class="col-md-5">
                                                    <label class="form-label">Pola Lingkungan<span
                                                            style="margin-left: 3.5rem;"> </span></label>
                                                </div>
                                                <div class="col-md-7 jarak_text">
                                                    <div class="col text_data_terbaru">
                                            ...
                                            <div class="row jarak_judul">
                                                <div class="col-md-5">
                                                    <label class="form-label">Pola Ruang <span
                                                            style="margin-left: 3.5rem;"> </span></label>
                                                </div>
                                                <div class="col-md-7 jarak_text">
                                                    <div class="col text_data_terbaru">
                                ...
                                <div class="row jarak_inmobile">
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <div style="max-height:8rem;" class="image_slider_input">
                                            ...
                                            @foreach ($datas as $gi)
                                                <div>
                                                    <img class="img_child img_child_id_perkembangan del_class_image"
                                                        data-id="{{ $gi->id }}"
                                                        data-lazy="https://jakpintas.dpmptsp-dki.com/survey/{{ count($gi->image) == 0 ? 'not_image.png' : $gi->image[0]->name }}"
                                                        alt="Image Child">
                                                </div>
                                            @endforeach
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table style="margin-bottom: 10rem;" class="display table table-striped"
                                        id="table-surveyer2" style="width: 100%">
                                    ...
                                    <tbody>
                                        @foreach ($data_detail as $pa)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ ucwords(strtolower($pa->kelurahan)) }}
                                                </td>
                                                <td class="text-center">{{ ucwords(strtolower($pa->kecamatan)) }}
                                                </td>
                ...
                <div style="margin-top: 1rem" class="row row-cards">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <h3 class="card-title">Traffic Pengunjung Harian Selama <span
                                            class="jumlah_hari">0</span> Hari Terakhir</h3>
                                    <div class="ms-auto">
                                        <div class="dropdown">
