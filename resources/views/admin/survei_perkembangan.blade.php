                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <div class="teks_height">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <label class="form-label">Arah Perkembangan Regional <span
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <label class="form-label">Pola Perkembangan Lingk.<span
                                                        style="margin-left: 3.5rem;"> </span></label>
                                            </div>
                                            <div class="col-md-7">
                                                <div class="col text_data_terbaru">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <label class="form-label">Tingkat Perkembangan Ruang <span
                                                        style="margin-left: 3.5rem;"> </span></label>
                                            </div>
                                            <div class="col-md-7">
                                                <div class="col text_data_terbaru">
                            ...
                            <div class="row">
                                <div class="col-md-12 mt-2">
                                    ...
                                    <div class="image_slider_input">
                                        ...
                                        @foreach ($datas as $gi)
                                            <div>
                                                <img class="img_child img_child_id_perkembangan"
                                                    data-id="{{ $gi->id }}"
                                                    src="https://jakpintas.dpmptsp-dki.com/survey/{{ count($gi->image) == 0 ? 'not_image.png' : $gi->image[0]->name }}"
                                                    alt="Image Child">
                                            </div>
                                        @endforeach
                                    </div>
