            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalEditAddLabel">Tambah Pegawai</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12 col-xl-12">
                                ...
                                <div class="mb-3">
                                    <div class="form-label">Penempatan</div>
                                    <select class="form-select" name="penempatan" id="" required>
        ...
        <div class="row row-cards">
            <div class="col-md-12 col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="display table table-striped" id="table-pegawai">
                            <thead>
                                <tr>
                                    <th>Nama</th>
                                    <th>E-mail</th>
                            ...
                            <tbody>
                                @foreach ($pegawai_ajib as $x)
                                <tr>
                                    <td>{{ $x->name }}</td>
                                    <td>{{ $x->email }}</td>
                                    <td> @if (!empty($x->getRoleNames()))
                                    ...
                                    <td>
                                        ...
                                        <div class="row row-cards">
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <a class="btn btn-tabler w-100 btn-icon" aria-label="Google" data-bs-toggle="modal" data-bs-target="#modalEditUsers" onclick="editPegawai({{ $x->id }}, '{{ $x->name }}', '{{ $x->email }}', '{{ $x->penempatan }}')">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                            </div>

                                            <div class="col-md-6 col-xl-6">
                                                <form action="{{ route('delete-pegawai') }}" class="d-inline" method="POST">
                                                    @csrf
                                                    @method('DELETE')
