            ...
            <div class="col-12">
                <div class="card-tabs ">
                    <div class="card-body" style="margin-top:-7%;">
                        ...
                        {{-- <textarea placeholder="Ketik pertanyaan" class="remove_border_textarea_pertanyaan mt-4"
                            oninput="auto_grow_textarea(this)" name="example-textarea-input" rows="1"></textarea>

                        <textarea oninput="Teks($(this))" oninput="auto_grow_textarea(this)" placeholder="Opsi Jawaban"
                            class="remove_textarea_option"></textarea> --}}
                        ...
                        <form method="post" action="#" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group mt-1 mb-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div style="margin-left:2.1rem;" class="col-md-11">
                                                        <textarea class="remove_textarea_judul" name="judul" rows="1"
                                                            placeholder="Judul Kuesioner">{{ $data['title'] }}</textarea>

                                                    </div>

                                                    <div style="margin-left:2.1rem;" class="col-md-11">
                                                        <textarea class="remove_textarea_deskripsi" name="deskripsi"
                                                            rows="1"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="AddGroup color_left" data-container="item{{ $i++ }}">
                                        <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row mt-3">
                                                                ...
                                                                <div style="margin-left:1.5rem;" class="col-md-8 mb-1">
                                                                    ...
                                                                    <textarea style="padding-left:0.2rem;"
                                                                        class="remove_border_textarea_pertanyaan"
                                                                        oninput="auto_grow_textarea(this)"
                                                                        name="example-textarea-input" rows="1"
                                                                        placeholder="Ketik pertanyaan">{{ $q['question'] }}</textarea>
                                                                ...
                                                                <div style="margin-left: 2.5rem;" class="col-md-3 mb-1">
                                                                    ...
                                                                    <select name="opsipertanyaan"
                                                                        ...
                                                                        <option value="file" {{ $q['type']=='file'
                                                                            ? 'selected' : '' }}
                                                                            data-icon="fa-solid fa-image fa-lg">
                                                                            Gambar
                                                                        </option>
                                                                ...
                                                                <div class="group_opsi radio mt-1" {!!
                                                                    ...
                                                                    <div style="margin-left: 1.2rem;" class="col-sm-10">
                                                                        ...
                                                                        <div class="hasil_addbtn1 pilihan-ganda">
                                                                            ...
                                                                            <div class="form-check hapusOption jawa">
                                                                                <div class="row">
                                                                                    <div class="col-md-11">
                                                                                        <input
                                                                                            class="form-check-input jawaban opsi_jawaban jawaban auto_input_textarea"
                                                                                            type="radio"
                                                                                            name="add_input_dinamis[]"
                                                                                            value="{{ $o['option'] }}" />
                                                                                        <textarea
                                                                                            oninput="Teks($(this)); auto_grow_options(this)"
                                                                                            placeholder="Opsi Jawaban"
                                                                                            class="remove_textarea_option auto_input color_active">{!! $o['option'] !!}</textarea>
                                                                                    </div>
                                                                                    <div class="col-md-1"
                                                                        ...
                                                                        <div
                                                                            class="form-check hapusOption d-none hide_textarea">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-7">
                                                                                    ...
                                                                                    <textarea
                                                                                        oninput="Teks($(this)); auto_grow_options(this)"
                                                                                        class="d-none" id="option"
                                                                                        placeholder="Opsi Jawaban"
                                                                                        class="remove_textarea_option option"
                                                                                        rows="1"></textarea>
                                                                    ...
                                                                    <div style="margin-left: 1.2rem;" class="col-sm-10">
                                                                        ...
                                                                        <div class="hasil_mulcen">
                                                                            ...
                                                                            <div class="form-check hapusOption">
                                                                                <div class="row">
                                                                                    <div class="col-md-11"><input
                                                                                            class="form-check-input jawaban auto_input_textarea"
                                                                                            type="checkbox"
                                                                                            name="add_input_dinamis[]"
                                                                                            value="{{ $o['option'] }}" /><textarea
                                                                                            class="remove_textarea_option color_active"
                                                                                            oninput="Teks($(this)); auto_grow_options(this)">{{ $o['option'] }}</textarea>
                                                                                    </div>
                                                                                    <div class="col-md-1"
                                                                                        style="position: absolute; margin: 8px 10px 10px 45rem"
                                                                                        ;><a href="javascript:void(0)"
                                                                        ...
                                                                        <div class="form-check hapusOption hide_textarea"
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-7">
                                                                                    ...
                                                                                    <textarea id="mulcen"
                                                                                        style="display: none"
                                                                                        placeholder="Opsi Jawaban proses"
                                                                                        class="remove_textarea_option txtBox2"></textarea>
                                                                                </div>

                                                                                <div class="col-md-1"
                                                                                    style="position: absolute; margin: 8px 10px 10px 45rem; display: none"
                                                                                    ;=""><a href="javascript:void(0)"
                                                                                        id="RemoveButton"><i
                                                                                            style="color: black"
                                                                                            class="material-icons">clear</i></a>
                                                                        ...
                                                                        <div class="form-check">
                                                                            <div class="row"
                                                                                ...
                                                                                <div class="col-md-10">
                                                                                    ...
                                                                                    <textarea onkeyup="teksPendek(this)"
                                                                                        class="jawaban remove_textarea_option_teks"
                                                                                        name="example-textarea-input"
                                                                                        rows="1" placeholder="Jawaban"
                                                                ...
                                                                {{-- Gambar2 --}}
                                                                <div class="group_opsi file pass" {!! $q['type']=='file'
                                                                    ? $show : $hide !!}>
                                                                    <div class="col-sm-10">
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    <div style="position: absolute;margin-top: 10px; margin-left:0"
                                                                                        ...
                                                                                        <label for="file-input">
                                                                                            {{-- <i
                                                                                                style="margin-top: 14px;margin-left: 12px; color:#000"
                                                            ...
                                                            <div class="row mt-3">
                                                                ...
                                                                <div style="margin-left:1.5rem;" class="col-md-8 mb-1">
                                                                    ...
                                                                    <textarea style="padding-left:0.2rem;"
                                                                        ...
                                                                        oninput="auto_grow_textarea(this)"
                                                                        name="example-textarea-input" rows="1"
                                                                        placeholder="Ketik pertanyaan"></textarea>
                                                                        ...
                                                                        <div class="form-check hide_textarea"
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-7">
                                                                                    ...
                                                                                    <textarea id="option2"
                                                                                        placeholder="Opsi Jawaban"
                                                                                        class="remove_textarea_option txtBox"></textarea>
